...
const SliderCardSkeleton: FC = () => {
  return (
    <div className='w-[100%] h-[100%] flex max-lg:flex-col gap-10 relative animate-pulse cursor-wait'>
      <div className='flex flex-col gap-7 w-[50%] max-lg:w-[100%] max-lg:order-2 order-1'>
        ...
        <div className='flex flex-wrap gap-2 mt-auto'>
          {[...Array(4)].map((_, i) => (
            <div key={i} className='bg-red/20 w-16 h-5 rounded-sm shadow-md'></div>
          ))}
        </div>
      </div>
