...
const AuthForm: FC = () => {
  ...
  const handleSign = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (path === "/signup") {
      ...
      if (
        filtered.password !== user.password ||
  ...
  return (
    <div className="bg-pink  rounded-2xl w-[440px] h-[780px] max-[500px]:w-full max-[500px]:h-full max-[500px]:bg-pink/50">
      <div className="flex flex-col h-full   px-6  py-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm flex flex-col  items-center justify-center gap-5 ">
          ...
          <div className="min-h-[72px]">
            {path === "/signup" ? (
              <h2 className=" text-center text-xl font-bold tracking-tight text-gray italic">
        ...
        <div className="mt-5 h-full sm:mx-auto sm:w-full flex flex-col sm:max-w-sm ">
